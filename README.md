...
这个是做 **AI 文档问答**产品时顺手做的免费小工具——只是关键词打分检索，不理解语义、不生成摘要、不做引用溯源。完整版是真正的 AI 语义问答，支持长文档摘要、关键信息问答、引用溯源，源码在这：[AI 文档问答网站源码](https://inzyxuashop.com/aiwenshu-yuanma.html)。
